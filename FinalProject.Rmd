...
#Research Question
African Swine fever is a viral disease that has caused major issues for the swine industry in numerous countries, including China, Vietnam, the Phillipines. China, home to half of the world's pigs, has been hit the hardest by African Swine fever. Countries have resorted to slaughtering their livestock and placing bans on transport of livestock in and out of the country. We would like to explore whether or not African Swine Fever had a major impact on the swine industry before the media released reports in 2019. 
...
To clean up the Monthly data on livestock, we only included the variables we wanted to work with: Country, Month, and Animal_Imp_or_Exp (in pounds). This data allows us to see the meat import and export differences on a monthly basis for each country. 
```{r}
#Monthly
...
Yearly_Movement_Country_One <-
  ...
  ggplot(data = Yearly_Movement_Country_One, aes(x = year, y = Rank))+
  geom_point()+
  aes(color = country, size = total_Movement)+
  theme(axis.text.x = element_text(angle = 45))+
  xlab("Year (Start of 2019)")
